...
public class CaCommercial extends CaPolicyRequest {
    ...
    public CaCommercial(String caRequestId, int caReturnCode, long caCustomerNum, long caPolicyNum, String caIssueDate, String caExpiryDate, String caLastchanged, long caBrokerid, String caBrokersref, int caPayment, String caBAddress, String caBPostcode, String caBLatitude, String caBLongitude, String caBCustomer, String caBPropType, int caBFirePeril, int caBFirePremium, int caBCrimePeril, int caBCrimePremium, int caBFloodPeril, int caBFloodPremium, int caBWeatherPeril, int caBWeatherPremium, int caBStatus, String caBRejectReason, String caBFiller) {
    ...
    protected CaCommercial(final CaCommercial that) {
        super(that);
    ...
    @Override
    public CaCommercial clone() {
        return new CaCommercial(this);
    }
    ...
    private boolean equals(CaCommercial that) {
    ...
    public boolean equals(Object that) {
        return (that instanceof CaCommercial other) && other.canEqual(this) && this.equals(other);
    }
    
    @Override
    public boolean canEqual(Object that) {
        return that instanceof CaCommercial;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(caBAddress);
        result = 31 * result + Objects.hashCode(caBPostcode);
        result = 31 * result + Objects.hashCode(caBLatitude);
        result = 31 * result + Objects.hashCode(caBLongitude);
        result = 31 * result + Objects.hashCode(caBCustomer);
        result = 31 * result + Objects.hashCode(caBPropType);
        result = 31 * result + Integer.hashCode(caBFirePeril);
        result = 31 * result + Integer.hashCode(caBFirePremium);
        result = 31 * result + Integer.hashCode(caBCrimePeril);
        result = 31 * result + Integer.hashCode(caBCrimePremium);
        result = 31 * result + Integer.hashCode(caBFloodPeril);
        result = 31 * result + Integer.hashCode(caBFloodPremium);
        result = 31 * result + Integer.hashCode(caBWeatherPeril);
        result = 31 * result + Integer.hashCode(caBWeatherPremium);
        result = 31 * result + Integer.hashCode(caBStatus);
        result = 31 * result + Objects.hashCode(caBRejectReason);
        result = 31 * result + Objects.hashCode(caBFiller);
        return result;
    }
    ...
    public int compareTo(Dfhcommarea1 that) {
        if (that instanceof CaCommercial other) {
