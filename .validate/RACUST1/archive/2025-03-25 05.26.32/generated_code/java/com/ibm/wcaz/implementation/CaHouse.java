...
public class CaHouse extends CaPolicyRequest {
    ...
    public CaHouse(String caRequestId, int caReturnCode, long caCustomerNum, long caPolicyNum, String caIssueDate, String caExpiryDate, String caLastchanged, long caBrokerid, String caBrokersref, int caPayment, String caHPropertyType, int caHBedrooms, int caHValue, String caHHouseName, String caHHouseNumber, String caHPostcode, String caHFiller) {
    ...
    protected CaHouse(final CaHouse that) {
        super(that);
    ...
    @Override
    public CaHouse clone() {
        return new CaHouse(this);
    }
    ...
    private boolean equals(CaHouse that) {
    ...
    public boolean equals(Object that) {
        return (that instanceof CaHouse other) && other.canEqual(this) && this.equals(other);
    }
    
    @Override
    public boolean canEqual(Object that) {
        return that instanceof CaHouse;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(caHPropertyType);
        result = 31 * result + Integer.hashCode(caHBedrooms);
        result = 31 * result + Integer.hashCode(caHValue);
        result = 31 * result + Objects.hashCode(caHHouseName);
        result = 31 * result + Objects.hashCode(caHHouseNumber);
        result = 31 * result + Objects.hashCode(caHPostcode);
        result = 31 * result + Objects.hashCode(caHFiller);
        return result;
    }
    ...
    public int compareTo(Dfhcommarea1 that) {
        if (that instanceof CaHouse other) {
