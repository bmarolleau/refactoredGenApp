...
public class CaClaim extends CaPolicyRequest {
    ...
    public CaClaim(String caRequestId, int caReturnCode, long caCustomerNum, long caPolicyNum, String caIssueDate, String caExpiryDate, String caLastchanged, long caBrokerid, String caBrokersref, int caPayment, long caCNum, String caCDate, int caCPaid, int caCValue, String caCCause, String caCObservations, String caCFiller) {
    ...
    protected CaClaim(final CaClaim that) {
        super(that);
    ...
    @Override
    public CaClaim clone() {
        return new CaClaim(this);
    }
    ...
    private boolean equals(CaClaim that) {
    ...
    public boolean equals(Object that) {
        return (that instanceof CaClaim other) && other.canEqual(this) && this.equals(other);
    }
    
    @Override
    public boolean canEqual(Object that) {
        return that instanceof CaClaim;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Long.hashCode(caCNum);
        result = 31 * result + Objects.hashCode(caCDate);
        result = 31 * result + Integer.hashCode(caCPaid);
        result = 31 * result + Integer.hashCode(caCValue);
        result = 31 * result + Objects.hashCode(caCCause);
        result = 31 * result + Objects.hashCode(caCObservations);
        result = 31 * result + Objects.hashCode(caCFiller);
        return result;
    }
    ...
    public int compareTo(Dfhcommarea1 that) {
        if (that instanceof CaClaim other) {
