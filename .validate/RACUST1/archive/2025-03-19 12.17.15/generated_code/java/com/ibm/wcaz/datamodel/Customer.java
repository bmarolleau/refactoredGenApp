...
public class Customer implements Cloneable, Comparable<Customer> {
    ...
    public Customer(int customernumber, String firstname, String lastname, Date dateofbirth, String housename, String housenumber, String postcode, String phonehome, String phonemobile, String emailaddress) {
    ...
    protected Customer(final Customer that) {
    ...
    public boolean equals(Object that) {
        return (that instanceof Customer other) && other.canEqual(this) && this.equals(other);
    }
    
    public boolean canEqual(Object that) {
        return that instanceof Customer;
    }
    
    @Override
    public int hashCode() {
        int result = 17;
        result = 31 * result + Integer.hashCode(customernumber);
        ...
        result = 31 * result + Objects.hashCode(emailaddress);
        return result;
    }
