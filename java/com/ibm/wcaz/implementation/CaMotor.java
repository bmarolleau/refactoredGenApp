...
public class CaMotor extends CaPolicyRequest {
    ...
    public CaMotor(String caRequestId, int caReturnCode, long caCustomerNum, long caPolicyNum, String caIssueDate, String caExpiryDate, String caLastchanged, long caBrokerid, String caBrokersref, int caPayment, String caMMake, String caMModel, int caMValue, String caMRegnumber, String caMColour, int caMCc, String caMManufactured, int caMPremium, int caMAccidents, String caMFiller) {
    ...
    protected CaMotor(final CaMotor that) {
        super(that);
    ...
    @Override
    public CaMotor clone() {
        return new CaMotor(this);
    }
    ...
    private boolean equals(CaMotor that) {
    ...
    public boolean equals(Object that) {
        return (that instanceof CaMotor other) && other.canEqual(this) && this.equals(other);
    }
    
    @Override
    public boolean canEqual(Object that) {
        return that instanceof CaMotor;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(caMMake);
        result = 31 * result + Objects.hashCode(caMModel);
        result = 31 * result + Integer.hashCode(caMValue);
        result = 31 * result + Objects.hashCode(caMRegnumber);
        result = 31 * result + Objects.hashCode(caMColour);
        result = 31 * result + Integer.hashCode(caMCc);
        result = 31 * result + Objects.hashCode(caMManufactured);
        result = 31 * result + Integer.hashCode(caMPremium);
        result = 31 * result + Integer.hashCode(caMAccidents);
        result = 31 * result + Objects.hashCode(caMFiller);
        return result;
    }
    ...
    public int compareTo(Dfhcommarea1 that) {
        if (that instanceof CaMotor other) {
