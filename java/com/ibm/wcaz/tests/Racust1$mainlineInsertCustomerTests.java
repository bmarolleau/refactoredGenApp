...
public class Racust1$mainlineInsertCustomerTests {
    ...
    MockedStatic<java.sql.Statement> mockStatement;
    ...
    public void setUp(){
        ...
        mockStatement = Mockito.mockStatic(java.sql.Statement.class);
    ...
    public void mainlineInsertCustomerTest_1() throws Exception{
        ...
        PowerMockito.when(conn.createStatement()).thenReturn(st);
        ...
        PowerMockito.when(st.executeQuery(ArgumentMatchers.anyString())).thenReturn(rs);
    ...
    public void mainlineInsertCustomerTest_2() throws Exception{
        ...
        // create class level variables
         ...
         racust1Obj.setDb2CustomernumInt(-40048);
        Racust1 racust1 = new Racust1();
        String lgacNcs = "0";
        int db2CustomernumInt = 0;
        ...
        // COMMENT: Skipping assertion since errorMsg is local var. 
        //        Assert.assertEquals("INSERT CUSTOMER", getValue(errorMsg.getEmVariable().getEmSqlreq()));
        Assert.assertEquals(40048, getValue(caCustomerRequest.getCaCustomerNum()));

        // Assertions for resource output
        Assert.assertTrue(resOutputValueMap.size()>0);
        Assert.assertEquals("-40048", getData(resOutputValueMap,556,"CUSTOMER.CUSTOMERNUMBER"));
    }
    ...
    public void mainlineInsertCustomerTest_3() throws Exception{
        ...
        // COMMENT: Skipping assertion since errorMsg is local var. 
        //        Assert.assertEquals("INSERT CUSTOMER", getValue(errorMsg.getEmVariable().getEmSqlreq()));
        Assert.assertEquals(469798767, getValue(racust1Obj.getDb2CustomernumInt()));
        Assert.assertEquals(469798767, getValue(caCustomerRequest.getCaCustomerNum()));
